...
import '../pages/CSS/WithGpt.css';
import '../components/Footer/Footer.css'
import gptlogo from '../components/Assets/gpt.svg';
import userlogo from '../components/Assets/user.svg';
                ...
                <div className="container">
                    <div className="withgpt__item">
                        <div className="withgpt__icon">
                            <img src={gptlogo} alt="" /> <span>CHAT GPT</span>
                        </div>
                        <div className="withgpt__text">
                            Hello! How can I assist you today?
                            {inputText && (
                                <div className="input-text santa-text">
                                    <img src={userlogo} alt="" /> : {inputText}
                                </div>
                            )}
                            {response && (
                                <div className="response">
                                    <img src={gptlogo} alt="" /> : {response}
                                </div>
                            )}
                        </div>
                    </div>
